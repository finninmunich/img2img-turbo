...
def main(args):
    ...
    tokenizer = AutoTokenizer.from_pretrained("/home/turing/cfs_cz/finn/codes/huggingface/AI-ModelScope/sd-turbo", subfolder="tokenizer", revision=args.revision, use_fast=False,)
    noise_scheduler_1step = make_1step_sched()
    text_encoder = CLIPTextModel.from_pretrained("/home/turing/cfs_cz/finn/codes/huggingface/AI-ModelScope/sd-turbo", subfolder="text_encoder").cuda()
